...
<html lang="en">
	<head>
		...
		<style type="text/css">
				...
				div#pastebin { width: 82%; float: left; margin-top: 0px; position: relative; padding-left: 1%; border-left: 1px dotted #999999; margin-bottom: 25px; }
				...
				#copyrightInfo { color: #CCCCCC; background: #E0E0E0; background: rgba(0, 0, 0, 0.5); font-size: xx-small; position: fixed; bottom: 0px; right: 0px; padding-bottom: 10px; text-align: right; width: 100%; padding-right: 20px; padding-top: 10px; }
...
if($requri != "install" && @$_POST['submit'])
	{
		...
		if(strlen(@$_POST['pasteEnter']) > 10 && $imageUpload && mb_strlen($paste['Content']) <= $CONFIG['pb_max_bytes'] && $db->insertPaste($paste['ID'], $paste))
			{ 
				echo "<div class=\"result\"><div class=\"success\">Your paste has been successfully recorded!</div><div class=\"confirmURL\">URL to your paste is <a href=\"" . $bin->linker($paste['ID']) . $exclam . "\">" . $bin->linker($paste['ID']) . "</a></div>"; }
		else {
